...
var queues = require("can-queues"); // symbols aren't enumerable ... we'd need a version of Object that treats them that way
...
function (_MixedInArray) {
  ...
  _createClass(ObservableArray, [{
    ...
    value: function push() {
      ...
      (_get2 = _get(_getPrototypeOf(ObservableArray.prototype), "push", this)).call.apply(_get2, [this].concat(items));
    }
  }, {
    key: "unshift",
    value: function unshift() {
      ...
      (_get3 = _get(_getPrototypeOf(ObservableArray.prototype), "unshift", this)).call.apply(_get3, [this].concat(items));
    }
  }, {
    key: "filter",
